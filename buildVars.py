...
addon_info = {
	...
	"addon_name": "audioLogger",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	"addon_summary": _("Audio Logger"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	"addon_description": _("""Records system audio output and WavePlayer output for debugging purposes.
Default keyboard gestures: NVDA+Alt+R to start recording, NVDA+Alt+T to stop and save recording.
Saved files will be in My Documents\\AudioLogger."""),
	# version
	"addon_version": "0.1",
	# Author(s)
	"addon_author": "gexgd0419 <gexgd0419@outlook.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/gexgd0419/NVDAAudioLogger",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/gexgd0419/NVDAAudioLogger",
